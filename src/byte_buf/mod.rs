...
impl ByteBuf {
    ...
    pub fn write_string_with_u8_be_len(&mut self, v: String) -> ByteResult<usize> {
        ...
        // write length
        self.write_u8_be(v.as_bytes().len() as u8).unwrap_or_else(|e|{println!("{:?}",e);0});
        // write string
    ...
    pub fn write_string_with_u16_be_len(&mut self, v: String) -> ByteResult<usize> {
        ...
        // write length
        self.write_u16_be(v.as_bytes().len() as u16).unwrap_or_else(|e|{println!("{:?}",e);0});
        // write string
        if let Ok(l) = self.write_string(v) {
            Ok(l)
        } else {
    ...
    pub fn write_string_with_u16_le_len(&mut self, v: String) -> ByteResult<usize> {
        ...
        // write length
        self.write_u16_le(v.as_bytes().len() as u16).unwrap_or_else(|e|{println!("{:?}",e);0});
        // write string
        if let Ok(l) = self.write_string(v) {
            Ok(l)
        } else {
    ...
    pub fn write_string_with_u32_be_len(&mut self, v: String) -> ByteResult<usize> {
        ...
        // write length
        self.write_u32_be(v.as_bytes().len() as u32).unwrap_or_else(|e|{println!("{:?}",e);0});
        // write string
        if let Ok(l) = self.write_string(v) {
            Ok(l)
        } else {
    ...
    pub fn write_string_with_u32_le_len(&mut self, v: String) -> ByteResult<usize> {
        ...
        // write length
        self.write_u32_le(v.as_bytes().len() as u32).unwrap_or_else(|e|{println!("{:?}",e);0});
        // write string
        if let Ok(l) = self.write_string(v) {
            Ok(l)
        } else {
